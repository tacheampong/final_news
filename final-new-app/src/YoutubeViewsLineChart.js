...
const YoutubeViewsLineChart = ({data,selectedTopic, setSelectedTopic}) => {
  var margin = { top: 20, left: 80, bottom: 70, right: 20 };
   ...
   return (
    <div>
     <h4 className="youtube-heading">Youtube Average Video Count by Topic Over Time</h4>
    <div>
...
export default YoutubeViewsLineChart;
