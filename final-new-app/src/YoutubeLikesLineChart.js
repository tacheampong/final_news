...
const YoutubeLikesLineChart = ({data, selectedTopic, setSelectedTopic}) => {
  var margin = { top: 20, left: 80, bottom: 70, right: 20 };
   ...
   const yMax = d3.max(aggregated, (topic) =>
     d3.max(topic.values, (d) => d.avg_like_count),
   );
   ...
   return (
   <div>
     <h4 className="youtube-heading">Youtube Average Like Count by Topic Over Time</h4>
    <div>
...
export default YoutubeLikesLineChart;
